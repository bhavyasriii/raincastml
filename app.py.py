...
# App title
st.markdown("<h1 style='text-align: center;'>🌦️ RainCastML</h1>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center;'>Predict rain using real-time weather and ML</h4>", unsafe_allow_html=True)
...
if city:
    ...
    if features:
        ...
        bg_color = "#e0f7fa" if prediction == 0 else "#e3f2fd"
